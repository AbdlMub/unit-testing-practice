/* 1. should break string into substrings
   2. should return empty if no string
   3. should return longer string into substrings
   4. should return with special character
   5. should return empty array if integer input
   6. should return substrings with more than one string input */

   const substrings = require("./string.js")
